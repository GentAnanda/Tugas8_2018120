...
import static com.example.bab8_2018120.DBmain.TABLENAME;
...
import com.example.bab8_2018120.databinding.DataBinding;
...
public class data extends AppCompatActivity {
    private DataBinding binding;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            binding =DataBinding.inflate(getLayoutInflater());
        ...
        private void insertData() {
            binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (rec != null) {
                        Toast.makeText(data.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                        binding.edtname.setText("");
                        binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                        binding.edtstar.setText("");
                        binding.edtprice.setText("");
                    } else {
                        Toast.makeText(data.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                    }
                }
            });
//for view display
            binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(data.this, DisplayData.class));
                }
            });
//for storing new data or update data
            binding.btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (recedit != -1) {
                        Toast.makeText(data.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
...
//edit hide and submit visible
                        ...
                        Intent a = new Intent(data.this, DisplayData.class);
                        startActivity(a);
                    }
                }
            });
